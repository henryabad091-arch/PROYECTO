...
def generar_factura(fecha, nombre_cliente, cedula_cliente, productos_in):
    ...
    Parámetros:
        ...
        cedula_cliente (str)  — cédula o RUC del cliente
        productos_in   (list) — lista de dicts con: nombre, cantidad, precio, iva

    Devuelve:
        Un dict con ok=True y todos los datos de la factura,
